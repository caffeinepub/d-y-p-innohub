...
export class Backend implements backendInterface {
    ...
    async addComment(arg0: ProjectId, arg1: string, arg2: string): Promise<Comment> {
        if (this.processError) {
            try {
    ...
    async createProject(arg0: string, arg1: string, arg2: Array<string>, arg3: string, arg4: string, arg5: Array<string>, arg6: string): Promise<Project> {
        if (this.processError) {
            try {
    ...
    async getProjectComments(arg0: ProjectId): Promise<Array<Comment>> {
        if (this.processError) {
            try {
    ...
    async getProjects(arg0: string | null, arg1: string | null): Promise<Array<Project>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProjects(to_candid_opt_n13(this._uploadFile, this._downloadFile, arg0), to_candid_opt_n13(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTopContributors(): Promise<Array<UserProfile>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTopContributors();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async likeProject(arg0: ProjectId): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.likeProject(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async recordProjectView(arg0: ProjectId): Promise<void> {
        if (this.processError) {
            try {
